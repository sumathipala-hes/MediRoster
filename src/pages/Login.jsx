...
const doctor = {email : "doctor@gmail.com" ,password:"doctor123"} 
const consultant = {email: "consultant@gmail.com" , password:"consultant123"}
...
const Login = () => {
  ...
  const handleSubmit=async(e)=>{
    ...
    if(email === "doctor@gmail.com" && password === "doctor123"){
      navigate("/schedule")
    }else if(email === "consultant@gmail.com" && password === "consultant123"){
